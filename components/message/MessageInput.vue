  ...
  <div class="reply-form">
      <form class="form">
        <div class="form-group">
          <small><a @click.stop="cancelReply" v-show="!replyStatus" class="cancel-reply">回复状态，点击我可以转到评论状态</a></small>
        ...
        <div class="form-group comment-user">
          <div class="row">
            ...
            <div class="col-md-3"><button type="button" @click="handleReply" class="btn btn-block btn-primary">{{replyStatus ? '发表评论' : `回复${byReply}`}}</button></div>
          </div>
        </div>
      </form>
    </div>
